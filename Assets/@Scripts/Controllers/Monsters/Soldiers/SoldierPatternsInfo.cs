...
namespace SoldierPatternsInfo
{
    ...
    public class WalkPatternInfo : PatternInfo
    {
        ...
        {
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.WalkPattern.MoveToTarget(_dist));
    ...
    public class OrbitMovePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.OrbitMovePattern.OrbitAroundPlayer());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BitePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            ...
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.BitePattern.Bite());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class PoisonBulletPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.PoisonBulletPattern.PoisonBullet());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class MoveToAllyPatternInfo : PatternInfo
    {
        ...
        public override bool PatternConditionCheck()
        {
            ...
            SoldierController pc = _patternUser as SoldierController;
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.MoveToAllyPattern.MoveToAlly(_stopDist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class RunAwayPatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new SoldierAttackPatterns.RunAwayPattern.RunAway(_dist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
}