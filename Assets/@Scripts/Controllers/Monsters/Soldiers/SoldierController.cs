...
public class SoldierController : MonsterController2
{
    ...
    [Header("Healer Soldier Properties")]
    //아군을 담고 있는 리스트
    ...
    protected override void Start()
    {
        ...
        {
            _patterns.Add(new SoldierPatternsInfo.BitePatternInfo(this, 3f, 2f));
            _patterns.Add(new SoldierPatternsInfo.WalkPatternInfo(this, 3f));
        }
        else if (type == AttackType.Ranger)
        {
            _patterns.Add(new SoldierPatternsInfo.PoisonBulletPatternInfo(this, 8f, 5f));
            _patterns.Add(new SoldierPatternsInfo.OrbitMovePatternInfo(this));
        }
    }
