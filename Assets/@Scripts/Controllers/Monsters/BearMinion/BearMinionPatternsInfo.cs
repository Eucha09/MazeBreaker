...
namespace BearMinionPatternsInfo
{
    ...
    public class WalkPatternInfo : PatternInfo
    {
        ...
        {
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.WalkPattern.MoveToTarget(_dist));
    ...
    public class OrbitMovePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.OrbitMovePattern.OrbitAroundPlayer());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BitePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            ...
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.BitePattern.Bite());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class TwoBitePatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.TwoBitePattern.TwoBite());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowDownPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.BurrowDownPattern.BurrowDown());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowMovePatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.BurrowMovePattern.BurrowMove());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowUpPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.BurrowUpPattern.BurrowUp());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class MoveToAllyPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.MoveToAllyPattern.MoveToAlly(_stopDist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class HealPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.HealPattern.Heal());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    //적이 가까울 때는 공격한다.
    ...
    public class RunAwayPatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new BearMinionAttackPatterns.RunAwayPattern.RunAway(_dist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
}