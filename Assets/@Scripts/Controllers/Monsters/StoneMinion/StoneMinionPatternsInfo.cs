...
namespace StoneMinionPatternsInfo
{
    ...
    public class WalkPatternInfo : PatternInfo
    {
        ...
        {
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.WalkPattern.MoveToTarget(_dist));
    ...
    public class OrbitMovePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.OrbitMovePattern.OrbitAroundPlayer());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BitePatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            ...
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.BitePattern.Bite());
            _patternUser.CurrentPatternInfo = this;
        }
    }

    public class LineAttackPatternInfo : PatternInfo
    {
        float _attackDist;

        public LineAttackPatternInfo(MonsterController2 patternUser, float attackDist, float coolTime)
        {
            _patternUser = patternUser;
            _patternName = "LineAttack";
            _attackDist = attackDist;
            _patternCoolTime = coolTime;
        }
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.LineAttackPattern.LineAttack());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowDownPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.BurrowDownPattern.BurrowDown());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowMovePatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.BurrowMovePattern.BurrowMove());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class BurrowUpPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.BurrowUpPattern.BurrowUp());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class MoveToAllyPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.MoveToAllyPattern.MoveToAlly(_stopDist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
    ...
    public class HealPatternInfo : PatternInfo
    {
        ...
        {
            _lastPatterUsedTime = Time.time;
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.HealPattern.Heal());
            _patternUser.CurrentPatternInfo = this;
        }
    }
    //적이 가까울 때는 공격한다.
    ...
    public class RunAwayPatternInfo : PatternInfo
    {
        ...
        public override void UsePattern()
        {
            _patternUser.CurrentState.ChangeState(new StoneMinionAttackPatterns.RunAwayPattern.RunAway(_dist));
            _patternUser.CurrentPatternInfo = this;
        }
    }
}