...
public class StoneMinionAnimationEventReciever : MonsterAnimationEventReciever
{
    ...
    public void Indicator()
    {
        ...
        {
            MonsterIndicator.ShowCone(45, 8, false, RpgIndicator.IndicatorColor.Enemy, 0);
            MonsterIndicator.Casting(.9f);  // 1.5초 동안 채워지고 끝나면 사라짐        }
        }
    ...
    public void GroundAttackEffect()
    {
        ...
        GameObject a = Managers.Resource.Instantiate("Effects/StoneMinion/GroundAttack", _monster.transform.position, _monster.transform.rotation);
    ...
    public void BurrowAttackEffect()
    {
        GameObject a = Managers.Resource.Instantiate("Effects/StoneMinion/BurrowAttack", _monster.transform.position, Quaternion.identity);
